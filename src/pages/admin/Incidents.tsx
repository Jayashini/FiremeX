		...
		<div class="flex flex-col gap-6 w-full pb-8">
			...
			<header class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 bg-brand-surface border border-brand-border rounded-3xl p-6">
				...
				<div class="flex flex-wrap items-center gap-3">
					...
					{/* Time filter */}
					<div class="relative">
						<select class="appearance-none bg-brand-surface border border-brand-border hover:border-slate-800 rounded-xl pl-9 pr-8 py-2 text-xs text-slate-300 font-semibold focus:outline-none cursor-pointer">
